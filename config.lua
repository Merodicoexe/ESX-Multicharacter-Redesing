...
if IsDuplicityVersion() then
    ...
    -- Added option to use /relog instead of kicking banned players
    -- When true, banned players will be forced to /relog instead of being kicked from server
    Config.UseRelogInsteadOfKick = true
    --------------------

    -- Added UI theme selection
    -- Theme 1: Dark Red (Original)
    -- Theme 2: Cyberpunk Blue/Purple
    -- Theme 3: Modern Green/Teal
    Config.UITheme = 1
    --------------------
